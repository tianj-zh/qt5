...
pushd %OUTPUT_PATH%
CALL %SOURCE_PATH%\configure.bat -mp -confirm-license -opensource -platform %QMAKESPEC% -debug-and-release -release -force-debug-info -force-asserts -opengl dynamic -prefix %PREFIX_PATH% -nomake tests -nomake examples
